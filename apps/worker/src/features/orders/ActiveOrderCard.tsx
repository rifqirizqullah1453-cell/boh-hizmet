...
import { CheckCircle, Play, MapPin, User, Phone, ClipboardCopy, Check } from "lucide-react";
      ...
      <div className="px-5 pt-5 pb-4">
        ...
        {(order.customerName || order.customerPhone) && (
          <div
            ...
            style={{ background: "rgba(43,197,212,0.06)" }}
          >
            <div
              className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0"
              style={{ background: "rgba(43,197,212,0.15)" }}
            >
        ...
        >
          <div className="flex items-start gap-2">
            <div className="flex flex-col items-center mt-0.5">
              ...
              <div className="w-0.5 h-6 mt-0.5" style={{ background: "var(--border)" }} />
            </div>
            ...
            <button
              ...
              className="ml-1 flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-colors"
              style={{ background: "rgba(43,197,212,0.1)", color: "var(--cyan)" }}
            >
              {copiedField === "pickup" ? <Check className="w-3.5 h-3.5" /> : <ClipboardCopy className="w-3.5 h-3.5" />}
            </button>
          </div>
          <div className="flex items-start gap-2">
            <div className="flex flex-col items-center mt-0.5">
            ...
            >
              {copiedField === "dest" ? <Check className="w-3.5 h-3.5" /> : <ClipboardCopy className="w-3.5 h-3.5" />}
            </button>
          </div>
        </div>
