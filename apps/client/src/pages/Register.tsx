              ...
              {role === 'customer' && (
                <div className="mt-5 space-y-3">
                  <div className="flex gap-3">
                    <motion.button onClick={handleGoogleRegister} disabled={googleLoading || fbLoading} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }}
                      className="flex-1 py-3 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 bg-white card-bg border-[1.5px] border-[var(--border)] border-dark hover:border-[var(--sky)] hover:shadow-md transition-all">
                      {googleLoading ? (
                    ...
                    <motion.button onClick={handleFacebookRegister} disabled={googleLoading || fbLoading} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }}
                      className="flex-1 py-3 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 bg-white card-bg border-[1.5px] border-[var(--border)] border-dark hover:border-blue-500 hover:shadow-md transition-all">
                      {fbLoading ? (
